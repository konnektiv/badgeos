...
xgettext --keyword=__ --keyword=_e --keyword=_n:1,2 --keyword=_x:1,2c --keyword=_ex:1,2c \
	--files-from=filelist --language=PHP --package-name BadgeOS -o - | sed 's/charset=CHARSET/charset=UTF-8/' > languages/$TEXTDOMAIN.pot
rm -f filelist
